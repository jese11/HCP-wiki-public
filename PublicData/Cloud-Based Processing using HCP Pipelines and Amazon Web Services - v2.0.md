---
title: Cloud-Based Processing using HCP Pipelines and Amazon Web Services - v2.0
created: '2015-06-03T09:31:48.384Z'
updated: '2015-06-03T17:03:56.970Z'
updated_by: Tim Brown
source: 
  https://wiki.humanconnectome.org/display/PublicData/Cloud-Based+Processing+using+HCP+Pipelines+and+Amazon+Web+Services+-+v2.0
space: PublicData
...
- ![](./assets/26.2.SearchingForHCP_PipelineClusterNode.png)
- ![](./assets/08.SearchingForHCP.png)
- ![](./assets/26.png)
